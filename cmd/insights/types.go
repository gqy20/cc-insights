...
type AgentAnalysisData struct {
	...
	ByModel            []AgentModelStat `json:"by_model,omitempty"`
}
...
// AgentModelStat 按模型归因的 agent 统计
type AgentModelStat struct {
	Model              string  `json:"model"`
	AgentID            string  `json:"agent_id"`
	AgentName          string  `json:"agent_name,omitempty"`
	IsSidechain        bool    `json:"is_sidechain"`
...
type CommandAnalysisData struct {
	...
	ByModel        []BashCommandModelStat  `json:"by_model,omitempty"`
}
...
// BashCommandModelStat 按模型归因的 Bash 命令统计
type BashCommandModelStat struct {
	Model              string  `json:"model"`
	CommandName        string  `json:"command_name"`
	CallCount          int     `json:"call_count"`
	SuccessCount       int     `json:"success_count"`
...
// FileOperationModelStat 按模型归因的文件操作统计
type FileOperationModelStat struct {
	Model              string  `json:"model"`
	Operation          string  `json:"operation"`
	Path               string  `json:"path"`
	CallCount          int     `json:"call_count"`
...
type FileAnalysisData struct {
	...
	ByModel      []FileOperationModelStat `json:"by_model,omitempty"`
}
...
type ProjectAggregate struct {
	...
	AgentModelStats         map[string]*AgentModelStat              `json:"-"`                // agent + 模型交叉
	...
	BashCommandModelStats   map[string]*BashCommandModelStat        `json:"-"`                // Bash 命令 + 模型交叉
	FileOperationStats      map[string]*FileOperationStat           `json:"-"`                // 文件操作统计
	FileOperationModelStats map[string]*FileOperationModelStat      `json:"-"`                // 文件操作 + 模型交叉
